          ...
          <div className="mt-20">
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
              <FeatureCard
                ...
                description="Build your network with fellow students, engage in meaningful conversations, and connected."
              />
              <FeatureCard
                icon={<GraduationCap className="h-6 w-6 text-white" />}
                title="Academic Updates"
                description="Stay updated with important academic announcements, events, and opportunities."
              />
              <FeatureCard
                icon={<Calendar className="h-6 w-6 text-white" />}
                title="Class Routines"
                description="Effortlessly access your class schedules and routines to stay organized."
              />
              <FeatureCard
                icon={<Bell className="h-6 w-6 text-white" />}
                title="Instant Notifications"
                description="Never miss important updates with real-time notifications, keeping you informed and connected."
              />
            </div>
          </div>
        </div>
